...
public class EstacionamentoIT {
    ...
    public void criarCheckin_ComDadosValidos_RetornarCreatedAndLocation() {
        ...
        testClient.post().uri("/api/v1/estacionamentos/check-in")
                ...
                .headers(JwtAutentication.getHeaderAuthorization(testClient, "ana@email.com.br", "123456"))
                .bodyValue(createDto)
                .exchange()
    ...
    public void criarCheckin_ComRoleCliente_RetornarErrorStatus403() {
        ...
        testClient.post().uri("/api/v1/estacionamentos/check-in")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAutentication.getHeaderAuthorization(testClient, "bia@email.com.br", "123456"))
                .bodyValue(createDto)
                .exchange()
    ...
    public void buscarCheckin_ComPerfilCliente_RetornarDadosStatus200() {
        ...
        testClient.get()
                .uri("/api/v1/estacionamentos/check-in/{recibo}", "20230313-101300")
                .headers(JwtAutentication.getHeaderAuthorization(testClient, "bob@email.com.br", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("placa").isEqualTo("FIT-1020")
