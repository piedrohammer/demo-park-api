...
public class UsuarioIT {
    ...
    public void createUsuario_ComPasswordInvalido_RetornarErrorMessageStatus422() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDTO("tody@email.com", "123456789000000000000000000"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        UsuarioResponseDTO responseBody = testClient
                ...
                .headers(JwtAutentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDTO.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                .get()
                .uri("/api/v1/usuarios/101")
                .headers(JwtAutentication.getHeaderAuthorization(testClient, "bia@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDTO.class)
                .returnResult().getResponseBody();
    ...
    public void editarSenha_ComCamposInvalidos_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .headers(JwtAutentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDTO("12345678000000000000000000", "12345678000000000000000000", "12345678000000000000000000"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
